...
class MainRestControllerAdviceUnitTest {
    ...
    void handleOtherExceptionTest() {
        ...
        Assertions.assertEquals("CALL_BARNA_FOR_MORE_DETAILS|test", mainRestControllerAdvice.handleOtherException(throwable));
