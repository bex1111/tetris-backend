...
class DownMoverUnitTest {
    ...
    void moveDownPoint4x2Test() {
        ...
        actualTrack = tetrisStepFactory.moveDown(actualTrack);
        actualTrack = tetrisStepFactory.moveDown(actualTrack);
        TrackElement[][] expectedTrack = new TrackElement[][]{
                new TrackElement[]{EMPTY, EMPTY},
                new TrackElement[]{EMPTY, EMPTY},
    ...
    @Test
    void moveDownPointMoreThenOneRowTest() {
        TrackElement[][] actualTrack = tetrisStepFactory.moveDown(new TrackElement[][]{
                new TrackElement[]{EMPTY, POINT, POINT},
                new TrackElement[]{EMPTY, EMPTY, EMPTY},
                new TrackElement[]{EMPTY, EMPTY, POINT},
                new TrackElement[]{EMPTY, POINT, POINT}
        });
        TrackElement[][] expectedTrack = new TrackElement[][]{
                new TrackElement[]{EMPTY, EMPTY, EMPTY},
    ...
    @Test
    void moveDownPointStopFullClearRowTest() {
        TrackElement[][] actualTrack = tetrisStepFactory.moveDown(new TrackElement[][]{
                new TrackElement[]{EMPTY, POINT, POINT},
                new TrackElement[]{EMPTY, EMPTY, EMPTY},
                new TrackElement[]{EMPTY, EMPTY, POINT},
